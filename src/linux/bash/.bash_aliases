...
alias z="clear && bash ~/.karma/scripts/fetch.sh && ls --group-directories-first -AFw1 && echo && s"
alias t="clear && bash ~/.karma/scripts/fetch.sh && ls --group-directories-first -AFRw1 && echo && s"
alias k="cd ~/.karma && z"
